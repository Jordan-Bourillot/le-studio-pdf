// POST /api/create-checkout — cree une session Stripe pour Le Studio PDF.
...
exports.handler = async (event) => {
  ...
  try {
    const session = await stripe.checkout.sessions.create({
      ...
      metadata: {
        // Filtre OBLIGATOIRE pour eviter le bug fan-out de webhooks Stripe :
        // chaque webhook produit doit verifier metadata.product avant d'agir.
        product: 'studio-pdf-v1',
